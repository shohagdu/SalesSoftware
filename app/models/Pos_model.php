    ...
    public function showAllPurchaseInfo($postData){
        ...
        if(!empty($records)) {
            foreach ($records as $key => $record) {
                ...
                $data[$key]->action = '<a href="'. base_url('pos/update/'.$record->id).'"  class="btn btn-primary  btn-sm"  ><i  class="glyphicon glyphicon-pencil"></i> Edit</a> <a href="'. base_url('pos/show/'.$record->id).'" class="btn btn-info  btn-sm"   ><i  class="glyphicon glyphicon-share-alt"></i> view</a>';
